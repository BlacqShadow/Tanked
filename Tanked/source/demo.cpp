...
int main()
{
	...
	/*	Create a new Wincanwas object passing window width and height with a string literal which is used instead of a
	 *	input string buffer.
	 */
	...
	while (wc.IsActive())
	{
		...
		wc.Write(250, 190, "Hello World", LRGB(255, 0, 0));
		wc.Display();
	}
	/**************************************************************************/
